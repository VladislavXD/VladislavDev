                ...
                <div className="menu_skills">
                        ...
                        <div className="left_skills">
                            <div className="menu__skills_item">
                                ...
                                <div left cascade className="skills__item_title">HTML5</div>
                                <div className="border"></div>
                            </div>
                            <div className="menu__skills_item">
                                <i className="fa-brands fa-css3-alt" style={{ color: '#007AF5' }}></i>
                                <div left cascade className="skills__item_title">CSS3</div>
                                <div className="border"></div>
                            </div>
                            <div className="menu__skills_item">
                                <i className="fa-brands fa-square-js" style={{ color: 'yellow' }}></i>
                                <div left cascade className="skills__item_title" >JavaScript</div>
                                <div className="border"></div>
                            </div>
                            <div className="menu__skills_item">
                                <i className="fa-brands fa-react" style={{ color: 'aqua' }}></i>
                                <div left cascade className="skills__item_title">React js</div>
                                <div className="border"></div>
                            </div>
                            <div className="menu__skills_item">
                                <i className="fa-brands fa-wordpress" style={{ color: '#5F97D0' }}></i>
                                <div left cascade className="skills__item_title">WordPress</div>
                                <div className="border"></div>
                            </div>
                            <div className="menu__skills_item">
                                <i className="fa-solid fa-database" style={{ color: '#8a8c8c' }}></i>
                                <div left cascade className="skills__item_title">MySql</div>
                                <div className="border"></div>
                            </div>
                        </div>
                    ...
                    <div className="right_skilss">
                        <div className="menu__skills_item">
                            ...
                            <div right cascade className="skills__item_title">Python</div>
                            <div className="border"></div>
                        </div>
                        <div className="menu__skills_item">
                            <i className="fa-brands fa-php"></i>
                            <div right cascade className="skills__item_title">PHP</div>
                            <div className="border"></div>
                        </div>
                        <div className="menu__skills_item">
                            ...
                            <div right cascade className="skills__item_title">TypeScript</div>
                            <div className="border"></div>
                        </div>
                        <div className="menu__skills_item">
                            <i className="fa-solid fa-database" style={{ color: '#8a8c8c' }}></i>
                            <div right cascade className="skills__item_title">SQlite</div>
                            <div className="border"></div>
                        </div>
                        <div className="menu__skills_item">
                            <i className="fab fa-gulp" style={{ color: 'red' }}></i>
                            <div right cascade className="skills__item_title">Gulp</div>
                            <div className="border"></div>
                        </div>
                        <div className="menu__skills_item" >
                            <i className="fab fa-bootstrap" ></i>
                            <div right cascade className="skills__item_title">Bootstrap</div>
                            <div className="border"></div>
                        </div>
                    </div>
                </div>
